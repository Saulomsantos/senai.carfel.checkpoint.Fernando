...
namespace Senai.Carfel.Checkpoint.Interfaces
{
    ...
    public interface IUsuarioRepositorio
    {
        ...
        /// com o e-mail e senha informados
        /// Caso exista, retorna o objeto do modelo encontrado
        /// </summary>
        /// <param name="email">O e-mail informado para busca</param>
        /// <param name="senha">A senha informada para busca</param>
        /// <returns>O usuário encontrado no banco, ou caso não encontre, retorna nulo</returns>
